...
Prompt: Please classify the conversation provided into one of the following categories: {categories}, and use the provided formatting instructions below. Don't explain, and only output the json.`;
}
